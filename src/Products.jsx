...
function Products({cartVisibility, setCartItems, cartItems, cart, changeShopName}) {
        ...
        <ul className='ml-2 mr-2 md:flex md:flex-wrap lg:ml-10 lg:grid  lg:grid-cols-4 lg:grid-rows-5'>
          {products.map(product => (
            <li key={product.id}>
              ...
              <button className='text-xl font-semibold w-2/3 ml-15 mb-5 rounded-lg hover:bg-yellow-500 text-center py-2 bg-yellow-300 md:font-extrabold md:w-4/5 md:ml-25 lg:w-3/6 lg:ml-2 lg:flex-row' onClick={() => addCart(product)}>Add to Cart</button>
